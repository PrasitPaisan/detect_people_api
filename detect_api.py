...
def save_detection(crop,frame,track_id,timestamp):
    obj_path = os.path.join(r"C:\Users\metthier\Desktop\Prasit_Paisan\helmet_detection\detect_people_api\saved_detections",f"crop_{track_id}_{timestamp}.jpg")
    overview_path = os.path.join(r"C:\Users\metthier\Desktop\Prasit_Paisan\helmet_detection\detect_people_api\overview_detections",f"frame_{track_id}_{timestamp}.jpg")
