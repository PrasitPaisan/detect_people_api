...
from ..utils.save_image_util import save_detection, save_image_to_googleStorage
from ..utils.generate_data_util import generate_data
from ..utils.image_processing_util import extract_detected_objects, draw_detection, find_closest_vehicle
...
async def detect_stream(request):
